...
export default function AgregarProfesorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await addProfessor(formData)
    ...
    if (success) {
      ...
      setError("Error al agregar el profesor. Intenta nuevamente.")
    }
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Agregar Nuevo Profesor</h1>
              <p className="text-gray-600">Completa la información del profesor</p>
            </div>
          </div>
        </div>
