...
import { RectorFormData } from "@/interfaces"
...
export default function AgregarRectorPage() {
  ...
  const { addRector, isLoading } = useRectorStore()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await addRector(formData)

    if (success) {
      setSuccess("Rector agregado exitosamente")
      setTimeout(() => {
        router.push("/dashboard/rectores")
      }, 2000)
    } else {
      setError("Error al agregar el rector. Intenta nuevamente.")
    }
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Agregar Nuevo Rector</h1>
              <p className="text-gray-600">Completa la información del rector</p>
            </div>
          </div>
        </div>
