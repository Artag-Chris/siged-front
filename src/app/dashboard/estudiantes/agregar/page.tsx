...
export default function AgregarEstudiantePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (existingStudent) {
      setError(`Ya existe un estudiante con el documento ${formData.tipoDocumento} ${formData.numeroDocumento}`)
      return
    }
    ...
    try {
      ...
      if (studentId) {
        ...
        setError("Error al agregar el estudiante. Intenta nuevamente.")
      }
    } catch (error) {
      setError("Error al agregar el estudiante. Intenta nuevamente.")
      console.error(error)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Agregar Nuevo Estudiante</h1>
              <p className="text-gray-600">Completa la información del estudiante</p>
            </div>
          </div>
        </div>
