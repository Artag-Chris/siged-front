...
export default function AgregarInstitucionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await addInstitution(formData)

    if (success) {
      setSuccess("Institución agregada exitosamente")
      setTimeout(() => {
        router.push("/dashboard/instituciones")
      }, 2000)
    } else {
      setError("Error al agregar la institución. Intenta nuevamente.")
    }
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Agregar Nueva Institución</h1>
              <p className="text-gray-600">Completa la información de la institución educativa</p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked:any) => handleInputChange("activa", checked)}
                />
